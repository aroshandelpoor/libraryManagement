/********************************************************************************
** Form generated from reading UI file 'dialoginsertmember.ui'
**
...
#ifndef UI_DIALOGINSERTMEMBER_H
#define UI_DIALOGINSERTMEMBER_H
...
public:
    ...
    void setupUi(QDialog *DialogInsertMember)
    {
        if (DialogInsertMember->objectName().isEmpty())
            DialogInsertMember->setObjectName("DialogInsertMember");
        DialogInsertMember->setWindowModality(Qt::ApplicationModal);
        DialogInsertMember->resize(512, 256);
        DialogInsertMember->setMinimumSize(QSize(512, 256));
        DialogInsertMember->setMaximumSize(QSize(512, 256));
        QFont font;
        font.setFamilies({QString::fromUtf8("IRANSansX")});
        DialogInsertMember->setFont(font);
        verticalLayout = new QVBoxLayout(DialogInsertMember);
        verticalLayout->setObjectName("verticalLayout");
        groupBox = new QGroupBox(DialogInsertMember);
        ...
        retranslateUi(DialogInsertMember);

        QMetaObject::connectSlotsByName(DialogInsertMember);
    } // setupUi

    void retranslateUi(QDialog *DialogInsertMember)
    {
        DialogInsertMember->setWindowTitle(QCoreApplication::translate("DialogInsertMember", "Dialog", nullptr));
        groupBox->setTitle(QCoreApplication::translate("DialogInsertMember", "\330\253\330\250\330\252 \330\247\330\271\330\266\330\247", nullptr));
        label_phonenumbermember_text->setText(QCoreApplication::translate("DialogInsertMember", "\330\264\331\205\330\247\330\261\331\207 \331\205\331\210\330\250\330\247\333\214\331\204:", nullptr));
        label_phonenumbermember_icon->setText(QString());
        label_membername_text->setText(QCoreApplication::translate("DialogInsertMember", "\331\206\330\247\331\205 \331\210 \331\206\330\247\331\205\342\200\214\330\256\330\247\331\206\331\210\330\247\330\257\332\257\333\214:", nullptr));
        label_membername_icon->setText(QString());
        label_birthdaymember_text->setText(QCoreApplication::translate("DialogInsertMember", "\330\252\330\247\330\261\333\214\330\256 \330\252\331\210\331\204\330\257:", nullptr));
        label_birthdaymember_icon->setText(QString());
        label_memberid_text->setText(QCoreApplication::translate("DialogInsertMember", "\332\251\330\257 \331\205\331\204\333\214:", nullptr));
        label_memberid_icon->setText(QString());
        radioButton_female->setText(QCoreApplication::translate("DialogInsertMember", "\330\262\331\206", nullptr));
        radioButton_male->setText(QCoreApplication::translate("DialogInsertMember", "\331\205\330\261\330\257", nullptr));
        label_gender->setText(QCoreApplication::translate("DialogInsertMember", "\330\254\331\206\330\263\333\214\330\252:", nullptr));
        pushButton_insert->setText(QCoreApplication::translate("DialogInsertMember", "\330\253\330\250\330\252", nullptr));
        pushButton_exit->setText(QCoreApplication::translate("DialogInsertMember", "\330\250\330\247\330\262\332\257\330\264\330\252", nullptr));
    } // retranslateUi

};

namespace Ui {
    class DialogInsertMember: public Ui_DialogInsertMember {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DIALOGINSERTMEMBER_H
